...
const Chatbot = () => {
    ...
    const [messages, setMessages] = useState([
        { role: 'ai', text: 'Hello! I am your Talent Ops AI assistant. Ask me about your tasks, leaves, timesheets, or anything else!' }
    ]);
            ...
            {isOpen && (
                <div style={{
                        ...
                        {messages.map((msg, i) => (
                            <div key={i} style={{ display: 'flex', gap: '8px', flexDirection: msg.role === 'user' ? 'row-reverse' : 'row' }}>
                                ...
                                <div style={{
                                    ...
                                    padding: '12px 16px',
                                    borderRadius: '16px',
                                    backgroundColor: msg.role === 'ai' ? 'var(--surface)' : 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)',
                                    background: msg.role === 'user' ? 'linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%)' : 'var(--surface)',
                    ...
                    <div style={{ 
                        ...
                        {['My tasks', 'Leave balance', 'My timesheets'].map((action) => (
                            <button
                                key={action}
                                onClick={() => {
                                    setInput(action);
